...
class ZombiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zombie" do
    assert_difference('Zombie.count') do
      post zombies_url, params: { zombie: { brain: @zombie.brain, kills: @zombie.kills, weapon: @zombie.weapon } }
    end
  ...
  test "should update zombie" do
    patch zombie_url(@zombie), params: { zombie: { brain: @zombie.brain, kills: @zombie.kills, weapon: @zombie.weapon } }
